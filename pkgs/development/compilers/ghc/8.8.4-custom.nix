...
stdenv.mkDerivation (rec {
  ...
  src = fetchurl {
    url = "https://ghcbuilds.s3.ap-south-1.amazonaws.com/ghc-8.8.4.20230519-src.tar.xz";
    sha256 = "1znpr63g1yf9x2whibjhd93ir0z8wnidlq360smg8rzrppsswwj2";
  };
  ...
  passthru = {
    ...
    haskellCompilerName = "ghc-${version}-custom";
  };
